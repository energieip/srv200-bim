...
energieip.CreateGroup = function (group) {
	...
	var content = {
		...
		"slopeStartManual": parseInt(group.slopeStartManual),
		"slopeStopManual": parseInt(group.slopeStopManual),
		"slopeStartAuto": parseInt(group.slopeStartAuto),
		"slopeStopAuto": parseInt(group.slopeStopAuto),
...
energieip.UpdateGroupCfg = function (driver) {
	...
	var content = {
		"group": parseInt(driver.statusGroup),
		"friendlyName": driver.groupConfigName,
		"slopeStartManual": parseInt(driver.groupConfigSlopeStartManual),
		"slopeStopManual": parseInt(driver.groupConfigSlopeStopManual),
		"slopeStartAuto": parseInt(driver.groupConfigSlopeStartAuto),
		"slopeStopAuto": parseInt(driver.groupConfigSlopeStopAuto),
